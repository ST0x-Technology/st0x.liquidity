...
| [0003](0003-durable-usdc-rebalance-guard-on-restart.md)                 | Reconstruct the USDC rebalancing guard from persisted state on startup               | Superseded by ADR-0015 |
...
| [0015](0015-reconstruct-pre-burn-usdc-inventory-on-resume.md)           | Reconstruct pre-burn Alpaca-to-Base USDC inventory before resume                     | Accepted               |
