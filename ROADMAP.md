...
[Milestone](https://github.com/ST0x-Technology/st0x.liquidity/milestone/1): Highly reliable counter trading with
auto-rebalancing in prod
...
| 2        | [#491] Trading enable/disable toggle  | [#492] | Gate rebalancing behind explicit opt-in    |
| 3        | [#296] Apalis infrastructure          | [#483] | Crash-safe orchestration layer             |
| 4        | [#449] Transfer aggregate ID tracking |        | Recovery needs to resume stalled transfers |
| 5        | [#421] Order lifecycle -> apalis jobs |        | Crash-safe order polling                   |

#### Production deployment

Stacked PRs preparing the first prod deploy with auto-rebalancing disabled, then gradually re-enabled.

- PR: [#502 fix: sqlx build issues the nix derivation](https://github.com/ST0x-Technology/st0x.liquidity/pull/502)
- PR: [#499 feat: give alastair access to the remote cli](https://github.com/ST0x-Technology/st0x.liquidity/pull/499)
- PR:
  [#498 disable everything before prod to re-enable gradually later](https://github.com/ST0x-Technology/st0x.liquidity/pull/498)
- PR: [#501 unify the websocket comms](https://github.com/ST0x-Technology/st0x.liquidity/pull/501)
- PR: [#503 preprod](https://github.com/ST0x-Technology/st0x.liquidity/pull/503)
...
- [#433]: Extend inventory snapshot -- WIP PR [#494](https://github.com/ST0x-Technology/st0x.liquidity/pull/494)

> Legend: 🔵 in progress | 🟣 in review | 🟡 ready (deps done or have stable branches to stack on) | 🔴 blocked (dep
> hasn't started, no branch to stack on) | 🟢 done
>
...
Add balance checks for every in-flight location, then wire them into the snapshot polling loop. [#429], [#430], and
[#432] are done. [#428] (PR [#485]) and [#431] (PR [#461]) are in review.
...
graph LR
    ...
    id428["#428 USDC on Alpaca<br/>PR #485"]:::review
    id429["#429 USDC on Ethereum<br/>PR #459"]:::done
    id430["#430 USDC on Base<br/>PR #460"]:::done
    id431["#431 Unwrapped equity on Base<br/>PR #461"]:::review
    id432["#432 Wrapped equity on Base<br/>PR #476"]:::done
...
- [ ] [#428 Check USDC balance in Alpaca crypto wallet](https://github.com/ST0x-Technology/st0x.liquidity/issues/428)
  - PR: [#485 Check USDC balance in Alpaca crypto wallet](https://github.com/ST0x-Technology/st0x.liquidity/pull/485)
...
- [x] [#432 Base wrapped equity token balance polling](https://github.com/ST0x-Technology/st0x.liquidity/issues/432)
  - PR: [#476 Add Base wrapped equity token balance polling](https://github.com/ST0x-Technology/st0x.liquidity/pull/476)
...
graph TD
    ...
    id296["#296 Apalis infrastructure<br/>PR #483"]:::wip
...
- [ ] [#296 Set up apalis + task-supervisor infrastructure and convert event processing pipeline](https://github.com/ST0x-Technology/st0x.liquidity/issues/296)
  - PR: [#483 redesign the orchestration layer](https://github.com/ST0x-Technology/st0x.liquidity/pull/483)
...
graph TD
    ...
    id354["#354 Turnkey signing<br/>PR #390"]:::done
    id380["#380 Wallet provider config<br/>PR #394"]:::done
...
graph TD
    ...
    id376["#376 DTO types<br/>PR #382"]:::review
    id377["#377 Backend WebSocket<br/>PR #482"]:::wip
    id378["#378 Frontend panels<br/>PR #392"]:::review
...
- [ ] [#377 Dashboard backend: serve inventory history and transfer status via WebSocket](https://github.com/ST0x-Technology/st0x.liquidity/issues/377)
  - PR: [#482 implement the inventory panel](https://github.com/ST0x-Technology/st0x.liquidity/pull/482)
...
- **[#449]** stores aggregate IDs alongside inflight balances so recovery can `Store::load(id)` and resume.
...
- [ ] [#491 Runtime trading enable/disable toggle](https://github.com/ST0x-Technology/st0x.liquidity/issues/491)
  - PR: [#492 feat/trading-switch](https://github.com/ST0x-Technology/st0x.liquidity/pull/492)
...
- [ ] [#455 Leaky tests](https://github.com/ST0x-Technology/st0x.liquidity/issues/455)
  - PR: [#487 fix flaky tests](https://github.com/ST0x-Technology/st0x.liquidity/pull/487)
...
- [x] [#332 No way to enable/disable individual asset markets](https://github.com/ST0x-Technology/st0x.liquidity/issues/332)
  - PR: [#335 add per-asset market enable/disable toggle](https://github.com/ST0x-Technology/st0x.liquidity/pull/335)
...
- [x] [#325 Upgrade Rain Orderbook bindings from V5 to V6](https://github.com/ST0x-Technology/st0x.liquidity/issues/325)
  - PR: [#326 upgrade Rain Orderbook bindings from V5 to V6](https://github.com/ST0x-Technology/st0x.liquidity/pull/326)
- [x] [#323 Fireblocks integration uses OneTimeAddress instead of whitelisted contract wallets](https://github.com/ST0x-Technology/st0x.liquidity/issues/323)
  - PR: [#324 fix fireblocks contract call destinations](https://github.com/ST0x-Technology/st0x.liquidity/pull/324)
- [x] [#310 StoreBuilder allows omitting projections that entities declare as required](https://github.com/ST0x-Technology/st0x.liquidity/issues/310)
  - PR: [#313 fix: projection wiring](https://github.com/ST0x-Technology/st0x.liquidity/pull/313)
- [x] [#306 Configurable operational limits for safe deployment rollout](https://github.com/ST0x-Technology/st0x.liquidity/issues/306)
  - PR: [#307 feat: configurable operational limits](https://github.com/ST0x-Technology/st0x.liquidity/pull/307)
- [x] [#426 Determine recovery strategy for detected in-flight capital](https://github.com/ST0x-Technology/st0x.liquidity/issues/426)
...
Migrated to event-sourced architecture and implemented automated rebalancing as the first major feature on the new
...
[#456]: https://github.com/ST0x-Technology/st0x.liquidity/issues/456
[#488]: https://github.com/ST0x-Technology/st0x.liquidity/issues/488
[#489]: https://github.com/ST0x-Technology/st0x.liquidity/issues/489
[#491]: https://github.com/ST0x-Technology/st0x.liquidity/issues/491
[#500]: https://github.com/ST0x-Technology/st0x.liquidity/issues/500
