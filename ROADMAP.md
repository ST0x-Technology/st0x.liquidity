...
NOTE: this hasn't been updated to account for the latest milestone splits
...
- [ ] Make sure the CD pipeline is working (in-progress. CI needs to pass for CD
      to be invoked. updating the stack so all branches below pass)
...
- [x] [#323 Fireblocks integration uses OneTimeAddress instead of whitelisted contract wallets](https://github.com/ST0x-Technology/st0x.liquidity/issues/323)
  - PR:
    [#324 fix fireblocks contract call destinations](https://github.com/ST0x-Technology/st0x.liquidity/pull/324)
- [x] [#310 StoreBuilder allows omitting projections that entities declare as required](https://github.com/ST0x-Technology/st0x.liquidity/issues/310)
  - PR:
    [#313 fix: projection wiring](https://github.com/ST0x-Technology/st0x.liquidity/pull/313)
...
[#494]: https://github.com/ST0x-Technology/st0x.liquidity/pull/494
