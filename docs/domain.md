...
This document is the source of truth for terminology in the st0x liquidity
codebase. Code names must be consistent with this document.

For naming conventions (`*Env`, `*Config`, `*Secrets`, `*Ctx`, `*Job`), see
[naming.md](naming.md).
