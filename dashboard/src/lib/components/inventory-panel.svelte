<script lang="ts">
  ...
  const equityEntries: GlossaryEntry[] = [
    ...
    { name: 'CT', def: 'Counter-trading / hedging status for this asset. Green means enabled; red means disabled.' },
    { name: 'Rebal', def: 'Automatic equity rebalancing status for this asset. Green means enabled; red means disabled.' },
    { name: 'Ext', def: 'Extended-hours counter-trading status for this asset. Green means enabled; red means disabled.' },
