...
async fn full_system() -> anyhow::Result<()> {
    ...
    let aapl_broker_price = dec!(150.25);
    let tsla_broker_price = dec!(245.00);
    ...
    let aapl_onchain_price = dec!(155.00);
    let aapl_sell_amount = dec!(10.75);
    ...
    let tsla_onchain_price = dec!(250.00);
    let tsla_buy_amount = dec!(5.0);
    ...
    let aapl_mint_price = dec!(150.00);
    let aapl_mint_amount = dec!(7.5);
    ...
    assert_eq!(
        ...
        FractionalShares::new(dec!(33.25)),
