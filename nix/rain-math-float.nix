...
rec {
  ...
  abiEnv = {
    RAIN_MATH_FLOAT_DECIMAL_FLOAT_ABI =
      "${abi}/DecimalFloat.sol/DecimalFloat.json";
    RAIN_MATH_FLOAT_TEST_DECIMAL_FLOAT_ABI =
      "${abi}/TestDecimalFloat.sol/TestDecimalFloat.json";
    ST0X_LIB_DECIMAL_FLOAT_ABI =
      "${abi}/LibDecimalFloat.sol/LibDecimalFloat.json";
  };
}
