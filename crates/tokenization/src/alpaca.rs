...
impl<W: Wallet> AlpacaTokenizationService<W> {
    ...
    pub(crate) async fn request_mint(
        ...
        self.client
            .request_mint(underlying_symbol, quantity, wallet, issuer_request_id)
            .await
    }
    ...
    pub(crate) async fn poll_mint_until_complete(
        ...
        self.client.poll_mint_until_complete(id).await
    }
    ...
    pub(crate) async fn poll_for_redemption(
        ...
        self.client.poll_for_redemption(tx_hash).await
    }
    ...
    pub(crate) async fn poll_redemption_until_complete(
        ...
        self.client.poll_redemption_until_complete(id).await
    }
