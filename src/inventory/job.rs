        ...
        match source {
            InventoryObservationSource::InflightEquity => {
                self.inflight_equity
                    .clone()
                    .push_with_delay(PollInflightEquity::default(), delay)
                    .await
            }
            InventoryObservationSource::OnchainEquity => {
                self.onchain_equity
                    .clone()
                    .push_with_delay(PollOnchainEquity::default(), delay)
                    .await
            }
            InventoryObservationSource::OnchainUsdc => {
                self.onchain_usdc
                    .clone()
                    .push_with_delay(PollOnchainUsdc::default(), delay)
                    .await
            }
            InventoryObservationSource::EthereumWalletUsdc => {
                self.ethereum_wallet_usdc
                    .clone()
                    .push_with_delay(PollEthereumWalletUsdc::default(), delay)
                    .await
            }
            InventoryObservationSource::BaseWalletUsdc => {
                self.base_wallet_usdc
                    .clone()
                    .push_with_delay(PollBaseWalletUsdc::default(), delay)
                    .await
            }
            InventoryObservationSource::BaseWalletUnwrappedEquity => {
                self.base_wallet_unwrapped_equity
                    .clone()
                    .push_with_delay(PollBaseWalletUnwrappedEquity::default(), delay)
                    .await
            }
            InventoryObservationSource::BaseWalletWrappedEquity => {
                self.base_wallet_wrapped_equity
                    .clone()
                    .push_with_delay(PollBaseWalletWrappedEquity::default(), delay)
                    .await
            }
            InventoryObservationSource::OffchainInventory => {
                self.offchain_inventory
                    .clone()
                    .push_with_delay(PollOffchainInventory::default(), delay)
                    .await
            }
        }
    }
    ...
    ($job:ident, $source:ident, $worker:literal, $label:literal) => {
        ...
        impl Job<InventoryPollingJobCtx> for $job {
            ...
            async fn perform(
                ...
                perform_inventory_poll(ctx, InventoryObservationSource::$source).await
            }
        }
    };
}
...
async fn perform_inventory_poll(
    ...
    ctx.queues.push_with_delay(source, ctx.interval).await?;
