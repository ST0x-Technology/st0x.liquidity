...
mod tests {
    ...
    #[test]
    fn venue_keyed_skip_streaks_round_trip_through_json() {
        let spym = Symbol::new("SPYM").unwrap();
        let view = InventoryView::default().note_equity_snapshot_skip(&spym, Venue::MarketMaking);
