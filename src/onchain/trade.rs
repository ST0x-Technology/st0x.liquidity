...
mod tests {
    ...
    fn test_float_constants_from_v5_interface() {
        ...
        let diff = (ExactDecimal::from_raw(float_one) - ed("1.0"))
            .unwrap()
            .abs()
            .unwrap();
        ...
        let diff = (ExactDecimal::from_raw(float_half) - ed("0.5"))
            .unwrap()
            .abs()
            .unwrap();
        assert!(diff < ed("0.000001"));
        ...
        let diff = (ExactDecimal::from_raw(float_two) - ed("2.0"))
            .unwrap()
            .abs()
            .unwrap();
        assert!(diff < ed("0.000001"));
    ...
    fn test_from_raw_production_event_data() {
        ...
        let shares_amount = ExactDecimal::from_raw(event_input_float);
        ...
        let usdc_amount = ExactDecimal::from_raw(event_output_float);
    ...
    fn test_from_raw_edge_cases() {
        let float_zero = Float::from_fixed_decimal(uint!(0_U256), 0)
            .unwrap()
            .get_inner();
        let diff = (ExactDecimal::from_raw(float_zero) - ed("0"))
            .unwrap()
            .abs()
            .unwrap();
        assert!(diff < ed("0.000001"));
        ...
        let float_one = Float::from_fixed_decimal(uint!(1_U256), 0)
            .unwrap()
            .get_inner();
        let diff = (ExactDecimal::from_raw(float_one) - ed("1"))
            .unwrap()
            .abs()
            .unwrap();
        assert!(diff < ed("0.000001"));
        ...
        let float_nine = Float::from_fixed_decimal(uint!(9_U256), 0)
            .unwrap()
            .get_inner();
        let result = ExactDecimal::from_raw(float_nine);
        ...
        let float_hundred = Float::from_fixed_decimal(uint!(100_U256), 0)
            .unwrap()
            .get_inner();
        let result = ExactDecimal::from_raw(float_hundred);
        ...
        let float_half = Float::from_fixed_decimal(uint!(5_U256), 1)
            .unwrap()
            .get_inner();
        let result = ExactDecimal::from_raw(float_half);
    ...
    fn test_from_raw_large_values() {
        ...
        let float_large = Float::from_fixed_decimal_lossy(U256::from(large_coeff), 0)
            ...
            .0
            .get_inner();
        let result = ExactDecimal::from_raw(float_large);
        ...
        let float_small = Float::from_fixed_decimal_lossy(uint!(1_U256), 50)
            ...
            .0
            .get_inner();
        let result = ExactDecimal::from_raw(float_small);
        assert!(
    ...
    fn test_from_raw_formatting_edge_cases() {
        let float_amount = Float::from_fixed_decimal(uint!(123_456_U256), 6)
            .unwrap()
            .get_inner();
        let result = ExactDecimal::from_raw(float_amount);
