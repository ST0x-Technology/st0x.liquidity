...
mod tests {
    ...
    async fn submit_offchain_order_with_executor<E: Executor + Clone + Send + Sync + 'static>(
        ...
        let accepted_order_id = format!("TEST:test-accept:{shares}");
        let accepted_executor_order_id = ExecutorOrderId::new(&accepted_order_id);
    ...
    /// requires a valid UUID string rather than the self-describing dry-run ID
    /// generated by [`submit_offchain_order_with_executor`].
    ...
    async fn poll_with_cancelled_partial_fill_records_fill_before_confirming_cancellation() {
        ...
        assert_eq!(
            ...
            TerminalPositionFinalization::Complete {
                ...
                executor_order_id: ExecutorOrderId::new("TEST:test-accept:100"),
            ...
            .send(
                ...
                OffchainOrderCommand::Place {
                    ...
                    kind: crate::offchain::order::CounterTradeOrderKind::OvernightLimit {
                        limit_price,
                        snapshot: eligible_overnight_snapshot(symbol),
    ...
    async fn poll_jobs_for_different_orders_run_independently() {
        ...
        let infra = build_test_infra(FailFirstExecutor {
            ...
            inner: MockExecutor::new().with_order_status(OrderState::Filled {
                executed_at: Utc::now(),
                order_id: ExecutorOrderId::new("test-fill"),
    ...
    fn broker_filled() -> OrderState {
        OrderState::Filled {
            ...
            shares_filled: Positive::new(FractionalShares::new(float!(2))).unwrap(),
            executed_at: Utc::now(),
        }
    }
